                        ...
                        <div data-aos="fade-left" data-aos-delay="400"  className=''>
                            ...
                            <div className='mt-[2rem] flex items-center space-x-6'>
                                <button 
                                    data-aos="zoom-in" 
                                    data-aos-delay="1200"
                                    className='relative flex h-[50px] w-40 items-center justify-center font-semibold overflow-hidden bg-red-500 text-white shadow-2xl transition-all 
                                ...
                                <button 
                                    data-aos="zoom-out" 
                                    data-aos-delay="1600"
                                    className='before:easy relative h-12 w-40 overflow-hidden bg-orange-600 text-white font-semibold shadow-2xl 
