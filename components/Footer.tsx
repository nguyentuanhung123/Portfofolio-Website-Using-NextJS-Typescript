            ...
            <div className='w-[80%] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[2rem] border-b-[1.4px] pb-5 border-gray-600 border-opacity-40'>
                <div>
                    ...
                    <h1 className='text-[14px] mt-[0.5rem] text-white opacity-70'>
                        Web Developer is not a new industry, but it is always among the top popular industries and there is a scarcity of human resources due to supply being less than demand. Besides, with the advantage of not being required to have a working space, you can work with a company or work freely at home. 
                    </h1>
