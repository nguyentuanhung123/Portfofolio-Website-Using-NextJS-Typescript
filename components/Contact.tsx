            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-[2rem] items-center w-[80%] mx-auto'>
                <div>
                    ...
                    <p className='text-[15px] text-white mt-[1rem] opacity-75'>
                        Brand is understood as a name, concept, symbol, image or a combination of all elements that create identification and distinct associations (rational, emotional) in the mind of customers. about a particular business or product.
                    </p>
